...
namespace Server.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Pay()
        {
            ...
            request.CallbackUrl = "https://localhost:7008/api/Payments/PayCallBak";
        ...
        [HttpPost]
        public async Task<IActionResult> PayCallBak([FromForm] IFormCollection collections)
        {
            ...
            await _hubContext.Clients.Client(PayHub.TransactionConnections[data.ConversationId]).SendAsync("Recive", data);
            return Ok();
        }
    }
}
